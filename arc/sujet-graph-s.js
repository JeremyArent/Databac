		...
		d3.json('serie_s', function(error, root) {
			...
			{	
    			if(d.name == 'fonctions' || d.name == 'suite' || d.name == 'géométrie' || d.name == 'SVT' || d.name == 'Série S' || d.name == 'Série ES' || d.name == 'Série L' || d.name == '2013' || d.name == '2012' || d.name == '2011' || d.name == '2010' || d.name == '2009' || d.name == 'Physique Chimie' || d.name == 'Philosophie' || d.name == 'Histoire Géographie' || d.name == 'SES' || d.name == 'Mathématiques' || d.name == 'Center'){
    				content.append("p")
